     ...
     var rooms = [
        {
            ...
            items: [
                { type: 'LED', name: 'LED TV', status: 'off', width: 30, height: 150, posx: 0, posy: 0},
                { type: 'LED', name: 'LED Couch', width: 30, height: 150, posx: 0, posy: 0},
                { type: 'TV Remote', name: 'TV Remote', width: 30, height: 150, posx: 0, posy: 0},
            ]
        }
    ]
