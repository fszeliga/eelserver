...
import els.threading.ClientInput;
import els.threading.ClientOutput;
...
public class Client {
	...
	private ClientInput clientInThread;
	private ClientOutput clientOutThread;
	...
	public Client(Socket clientSocket) {
		...
		clientInThread = new ClientInput(this, this.clientSocket);
		clientInThread.start();
		
		clientOutThread = new ClientOutput(this, this.clientSocket);
	...
	public synchronized void disconnect(){
		try {
			clientInThread.closeInput();
			clientOutThread.closeOutput();
			clientSocket.close();
		} catch (IOException e) {
